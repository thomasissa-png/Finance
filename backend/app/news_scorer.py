...
from .config import ASSETS, NEWS_FRESHNESS_PEAK_HOURS, NEWS_MAX_AGE_HOURS
...
5. **reasoning** : explication en 1-2 phrases de ton analyse
...
{{"index": 1, "surprise": 0-100, "directional_clarity": 0-100, "direction": "LONG"|"SHORT"|"NEUTRAL", "impacted_tickers": ["TICKER1"], "reasoning": "..."}}"""
